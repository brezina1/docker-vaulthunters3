# [Vault Hunters 3rd Edition-3.14.1](https://www.curseforge.com/minecraft/modpacks/vault-hunters-1-18-2) on Curseforge
...
The docker on first run will download the same version as tagged of `Vault Hunters 3rd Edition-3.14.1` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "Vault Hunters 3rd Edition-3.14.1 Server Powered by Docker"
* LEVEL world
